...
__DEFINE__(1646390020248, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1646390020249,"./event-store":1646390020250}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1646390020249, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1646390020250, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1646390020249,"./utils":1646390020251}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1646390020251, function(require, module, exports) {
...
return __REQUIRE__(1646390020248);
})()
